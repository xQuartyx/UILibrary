...
function Library:CreateWindow(...)
    ...
    Library:GiveSignal(InputService.InputBegan:Connect(function(Input, Processed)
        ...
        elseif Input.KeyCode == Enum.KeyCode.RightControl or (_G.Keybind and Input.KeyCode.Name == _G.Keybind) or Input.KeyCode.Name == "F5" or (Input.KeyCode == Enum.KeyCode.RightShift and (not Processed)) then
            task.spawn(Library.Toggle)
        end
    end))
