...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "https://quartyz.dev/Lua/Lib/Mercury"
	}, options)
	...
	creditsTab:credit{Name = "Quartyz", Description = "UI Library Editer", Discord = "Quartyz#3561", V3rmillion = "Quartyz"}
...
function Library:_theme_selector()
	...
	local colorThemesContainer;
	if themesCount > 5 then
		colorThemesContainer = themeContainer:object("ScrollingFrame", {
			Size = UDim2.new(1, 0, 1, -32),
			BackgroundTransparency = 1,
			Position = UDim2.new(0.5, 0, 1, -5),
			AnchorPoint = Vector2.new(0.5, 1),
			CanvasSize = UDim2.new(0, 0, 0, 182),
			ScrollBarThickness = 3
		})
	else
		colorThemesContainer = themeContainer:object("Frame", {
			Size = UDim2.new(1, 0, 1, -32),
			BackgroundTransparency = 1,
			Position = UDim2.new(0.5, 0, 1, -5),
			AnchorPoint = Vector2.new(0.5, 1)
